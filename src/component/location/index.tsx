        ...
        <div className="location-info">
          ...
          <div className="content">
            * 버스 이용 시
            ...
            <br />
             &nbsp;&nbsp9802, M4403, M4434, M4448, M4449, 
            <br />
             &nbsp;&nbspM5422, M5438, M5443, M6410, M6450
            <br />
            - 마을: 6, 11-3, 917
            <br />
            - 직행: 6, 11-3, 917
            ...
            <br />
             &nbsp;&nbsp3008, 3030, 3100, 3101, 3102, 3201, 3800, 
            <br />
             &nbsp;&nbsp5200, 5300, 9202, 9400, 9700, G1003, 
            <br />
             &nbsp;&nbspG3900, G8157, G9633
            <br />
          </div>
        </div>
        <div className="location-info">
